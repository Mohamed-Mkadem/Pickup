...
class TicketClosedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line("The Ticket number #{$this->ticket->id} ({$this->ticket->title}) Was Closed By {$this->sender->full_name}")
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'body' => "The Ticket number #{$this->ticket->id} Was Closed By {$this->sender->full_name}",
