...
class VerificationRequestPolicy
{
    ...
    {
        return $user->seller->id == $verificationRequest->seller_id;
    }
     ...
     */
    public function restore(User $user, VerificationRequest $verificationRequest)
    {
        //
    }
     ...
     */
    public function forceDelete(User $user, VerificationRequest $verificationRequest)
    {
        //
    }
}
