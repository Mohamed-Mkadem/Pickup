        ...
        <div class="container">
            <div class="showcase-wrapper">
                <div class="text-info col">
                    ...
                    <a href="" class="btn cta-btn outlined-btn">More Info</a>
                </div>
    ...
    <section class="guidelines section">
        <div class="container">
            ...
            <div class=" guidelines-holder">
                ...
                <a href="{{ asset('dist/Assets/store.svg') }}" download="Sectors Guidelines" class="cta-btn ">Download
                    Guidelines</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="fees-wrapper wrapper ">
                ...
                <div class="col">
                    <header>
                        <h3>Subscription</h3>
                        <p class="price">29 DT<small>/Month</small> </p>
                    </header>
                    <ul class="features">
    ...
    <section class="section cta">
        <div class="container">
            <div class="cta-wrapper t-center">
                <p><i class="fa-light fa-shop"></i> +1.000 Stores Already Joined Pickup</p>
