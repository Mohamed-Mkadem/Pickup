                    ...
                    <div class="ticket-details header-details">
                        <div class="detail">
                            @if ($ticket->user->type == 'Client')
                                <span>By :</span> <a
                                    href="{{ route('admin.clients.show', $ticket->user->id) }}">{{ $ticket->user->full_name }}
                                    ({{ $ticket->user->type }})</a>
                            @else
                                <span>By :</span> <a
                                    href="{{ route('admin.sellers.show', $ticket->user->id) }}">{{ $ticket->user->full_name }}
                                    ({{ $ticket->user->type }})</a>
                            @endif
                        </div>
                        <div class="detail">
            ...
            <div class="ticket-details-holder holder">
                ...
                @if ($ticket->status != 'closed')
                    ...
                    <div class="detail new-response">
                        <h2>New Response</h2>
                        <form action="{{ route('admin.tickets.response.new', $ticket->id) }}" method="post"
