    ...
    <section class="content" id="content">
        ...
        <div class="filters-holder">
            ...
            <div class="filters-wrapper" id="filters-wrapper">
                <form action="{{ route('admin.transfers.filter') }}" method="GET">
                            ...
                            <tbody>
                                @foreach ($transfers as $transfer)
                                    <tr>
                                        ...
                                        <td>#{{ $transfer->id }}</td>
                                        <td><a
                                                href="{{ route('admin.store.home', $transfer->store->username) }}">{{ $transfer->store->name }}</a>
                                        </td>
                                        <td><a
                                                href="{{ route('admin.sellers.show', $transfer->seller->id) }}">{{ $transfer->seller->full_name }}</a>
                                        </td>
