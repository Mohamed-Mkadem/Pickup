...
@section('content')
    ...
    <section class="content" id="content">
        ...
        <div class="starter-header d-flex a-center j-sp-between col" id="starter-header">
            <h1>Tickets</h1>
            <!-- Start Link  -->
            <a href="{{ route('seller.tickets.create') }}" class="header-btn d-block add-btn">
        ...
        <div class="filters-holder">
            ...
            <div class="filters-wrapper" id="filters-wrapper">
                <form action="{{ route('seller.tickets.filter') }}" method="get">
                        ...
                        <table>
                            ...
                            <tbody>
                                @foreach ($tickets as $ticket)
                                    <tr>
                                        <td><a
                                                href="{{ route('seller.tickets.show', $ticket->id) }}">#{{ $ticket->id }}</a>
                                        </td>
