    ...
    <section class="content" id="content">
            ...
            <div class="pop-up-holder  ">
                <div class="pop-up form-pop-up lg">
                    ...
                    <div class="pop-up-body">
                        <!-- Start Form -->
                        <form action="{{ route('seller.revenues.store') }}" method="post" id="add-form">
                            @csrf
                            <div class="form-row  ">
                                <div class="col">
                                    <div class="form-control">
                                        ...
                                        <input type="text" name="title" value="{{ old('title', '') }}" id="title-input"
                                            placeholder="Revenue Title" class="form-element">
            ...
            <div class="stat-item">
                ...
                <div class="top-info d-flex a-start j-sp-between">
                    <div class="title-value-box">
                        ...
                        <p class="box-value">{{ Auth::user()->getRevenueStatistics()['currentPeriod']['total'] }} </p>
                    </div>
            ...
            <div class="stat-item">
                ...
                <div class="top-info d-flex a-start j-sp-between">
                    <div class="title-value-box">
                        ...
                        <p class="box-value">{{ Auth::user()->getRevenueStatistics()['currentPeriod']['day'] }} </p>
                    </div>
                ...
                <div class="bottom-info d-flex j-start a-center tickets-list">
                    ...
                    @if (Auth::user()->getRevenueStatistics()['difference']['day'] > 0) success
                    @elseif(Auth::user()->getRevenueStatistics()['difference']['day'] < 0)
                        danger @endif
                    
                    ">
                            <span>{{ Auth::user()->getRevenueStatistics()['difference']['day'] }}</span>
                        </p>
                    </div>
            ...
            <div class="stat-item">
                ...
                <div class="top-info d-flex a-start j-sp-between">
                    <div class="title-value-box">
                        ...
                        <p class="box-value">{{ Auth::user()->getRevenueStatistics()['currentPeriod']['week'] }} </p>
                    </div>
                ...
                <div class="bottom-info d-flex j-start a-center tickets-list">
                    <div class="progression-box">
                        ...
                        <p
                            class="progression-value 
                    @if (Auth::user()->getRevenueStatistics()['difference']['week'] > 0) success
                    @elseif(Auth::user()->getRevenueStatistics()['difference']['week'] < 0)
                        danger @endif
                    
                    ">
                            <span>{{ Auth::user()->getRevenueStatistics()['difference']['week'] }}</span>
                        </p>
                    </div>
            ...
            <div class="stat-item">
                ...
                <div class="top-info d-flex a-start j-sp-between">
                    <div class="title-value-box">
                        ...
                        <p class="box-value">{{ Auth::user()->getRevenueStatistics()['currentPeriod']['month'] }} </p>
                    </div>
                ...
                <div class="bottom-info d-flex j-start a-center tickets-list">
                    <div class="progression-box">
                        ...
                        <p
                            class="progression-value 
                    @if (Auth::user()->getRevenueStatistics()['difference']['month'] > 0) success
                    @elseif(Auth::user()->getRevenueStatistics()['difference']['month'] < 0)
                        danger @endif
                    
                    ">
                            <span>{{ Auth::user()->getRevenueStatistics()['difference']['month'] }}</span>
                        </p>
                    </div>
            ...
            <div class="stat-item">
                ...
                <div class="top-info d-flex a-start j-sp-between">
                    <div class="title-value-box">
                        ...
                        <p class="box-value">{{ Auth::user()->getRevenueStatistics()['currentPeriod']['year'] }} </p>
                    </div>
                ...
                <div class="bottom-info d-flex j-start a-center tickets-list">
                    <div class="progression-box">
                        ...
                        <p
                            class="progression-value 
                    @if (Auth::user()->getRevenueStatistics()['difference']['year'] > 0) success
                    @elseif(Auth::user()->getRevenueStatistics()['difference']['year'] < 0)
                        danger @endif
                    ">
                            <span>{{ Auth::user()->getRevenueStatistics()['difference']['year'] }}</span>
                        </p>
                    </div>
        ...
        <div class="filters-holder">
            ...
            <div class="filters-wrapper" id="filters-wrapper">
                <form action="{{ route('seller.revenues.filter') }}" method="get">

                    <div class="filter-row row3">
                        <div class="filter-box">
                            <label for="" class="form-label">Search</label>
                            <input type="search" name="search" value="{{ request()->search }}"
                                placeholder="Type An Revenue ID" class="form-element">
                        </div>
                        ...
                        <div class="filter-box">
                            ...
                            <div class="select-box">
                                <select name="category" class="form-element">
                                    ...
                                    @foreach ($categories['seller'] as $category)
                            ...
                            <tbody>
                                @foreach ($revenues as $revenue)
                                    <tr>
                                        ...
                                        <td>{{ number_format($revenue->amount, 3, ',') }}</td>


                                        <td>{{ $revenue->created_at->format('M jS Y - H:i') }}</td>
                                        <td>
                                            <ul class="d-flex j-center a-center actions">
                                                <li>
                                                    <button class="showBtn td-btn" title="Show Revenue"><i
                                                ...
                                                <li>
                                                    <button class="editBtn td-btn" title="Edit Revenue"><i
                                                    ...
                                                    <div class="modal-holder ">
                                                        <div class="modal lg">
                                                            ...
                                                            <form
                                                                action="{{ route('seller.revenues.update', $revenue->id) }}"
                                                                ...
                                                                <div class="form-row  ">
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="editor-holder pop-up-editor">
                                                                            ...
                                                                            <textarea name="description" cols="30" rows="10" class="form-element editor-input">{{ $revenue->description }}</textarea>
                                                                            <p class="error-message">This Field Is
                                                                                Required </p>
                                                                        </div>
                                                                    </div>
                                                ...
                                                @if ($revenue->revenueable_type == 'App\Models\Revenueable')
                                                    <li>
                                                        <button class="deleteBtn td-btn" title="Delete Revenue"><i
                                                                class="fa-light fa-trash"></i></button>
                                                        <div class="modal-holder ">
                                                            <form
                                                                action="{{ route('seller.revenues.destroy', $revenue->id) }}"
