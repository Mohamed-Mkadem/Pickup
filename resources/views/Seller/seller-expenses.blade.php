    ...
    <section class="content" id="content">
            ...
            <div class="pop-up-holder  ">
                <div class="pop-up form-pop-up lg">
                    ...
                    <div class="pop-up-body">
                        <!-- Start Form -->
                        <form action="{{ route('seller.expenses.store') }}" method="post" id="add-form">
                            @csrf
                            <div class="form-row  ">
                                <div class="col">
        ...
        <div class="filters-holder">
            ...
            <div class="filters-wrapper" id="filters-wrapper">
                <form action="{{ route('seller.expenses.filter') }}" method="get">
                                            ...
                                            <ul class="d-flex j-center a-center actions">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="modal-holder ">
                                                        <div class="modal lg">
                                                            ...
                                                            <form
                                                                action="{{ route('seller.expenses.update', $expense->id) }}"
                                                ...
                                                @if ($expense->expensable_type == 'App\Models\Expensable')
                                                    <li>
                                                        ...
                                                        <div class="modal-holder ">
                                                            <form
                                                                action="{{ route('seller.expenses.destroy', $expense->id) }}"
