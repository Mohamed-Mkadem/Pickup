...
@push('title')
    <title>Pickup | New Product</title>
@endpush
@section('content')
    <section class="content" id="content">
        ...
        @if ($store->isBanned())
            <div class="alert alert-error">
                <h3>Info</h3>
                <p>We're sorry, but your store is currently banned. You are unable to add new products until we resolve this
                    situation
                </p>
            </div>
        @else
            ...
            <form action="{{ route('seller.products.store') }}" method="post" id="creation-form" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="vertical-statuses-wrapper">
                                <div class="status form-element">
                                    ...
                                    <input type="radio" checked id="active"
                                        {{ old('status') == 'active' ? 'checked' : '' }} name="status" value="active">
                                </div>
                                <div class="status form-element">
                                    <label for="active ">Inactive</label>
                                    <input type="radio" id="inactive" {{ old('status') == 'inactive' ? 'checked' : '' }}
                        ...
                        <div class="filter-column">
                            ...
                            <div class="form-control">
                                ...
                                <div class="filter-holder ">
                                    ...
                                    <div class="filter-wrapper">
                                        <div class="form-control">
                                            <input type="search" class="form-element" name="brands"
                                                placeholder="Brand Name" id="brands-search">
                                        </div>
                                        ...
                                        <div class="choices brands-choices">
                                            @foreach ($brands as $brand)
                                                <div class="choice">
                                                    <input type="radio"
                                                        {{ old('brand_id') == $brand->id ? 'checked' : '' }} name="brand_id"
                        ...
                        <div class="holder p-1 radius-10">
                                ...
                                <div class="choices-btns-wrapper  ">
                                    <div class="choice-btn form-element">
                                        ...
                                        <input type="radio" checked id="piece-input"
                                            {{ old('unit') == 'piece' ? 'checked' : '' }} name="unit" value="piece">
                                    </div>
                                    <div class="choice-btn form-element">
                                        <label for="weight-input">weight</label>
                                        <input type="radio" id="weight-input"
                                            {{ old('unit') == 'weight' ? 'checked' : '' }} name="unit" value="weight">
                                    </div>
                                    <div class="choice-btn form-element">
                                        <label for="liquid-input">liquid</label>
                                        <input type="radio" id="liquid-input"
                                            {{ old('unit') == 'liquid' ? 'checked' : '' }} name="unit" value="liquid">
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-control">
                                    ...
                                    <input type="number" name="quantity" id="quantity-input" placeholder="eg: 100"
                                        class="form-element" inputmode="numeric"value="{{ old('quantity', '') }}">
                                    <p class="error-message">This field is required</p>
                                </div>
                                <div class="form-control">
                                    <label for="" class="form-label required">Stock Alert</label>
                                    <input type="number" name="stock_alert" id="stock-alert-input" placeholder="eg: 10"
                                        class="form-element" inputmode="numeric" value="{{ old('stock_alert', '') }}">
                                    <p class="error-message">This field is required</p>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-control">
                                    ...
                                    <input type="number" name="cost_price" id="cost-input" placeholder="eg: 7"
                                        class="form-element" inputmode="numeric"step="0.01"
                                        value="{{ old('cost_price', '') }}">
                                    <p class="error-message">This field is required</p>
                                </div>
                                <div class="form-control">
                                    <label for="" class="form-label required">Sale Price (DT)</label>
                                    <input type="number" name="price" id="price-input" placeholder="eg: 11"
                                        class="form-element" inputmode="numeric" step="0.01"
                                        value="{{ old('price', '') }}">
                                    <p class="error-message">This field is required</p>
                                </div>
                        ...
                        <div class="holder p-1 radius-10 mt-2">
                            ...
                            <div class="form-control">
                                ...
                                <textarea class="form-element" placeholder="The info Of The Product (Like Wheight, Dimenstions...etc)" name="info"
                                    id="info" rows="10" cols="80">{{ old('info', '') }}</textarea>
                            ...
                            <div class="form-control">
                                ...
                                <textarea class="form-element"
                                    ...
                                    id="ingredients" rows="10" cols="80">{{ old('ingredients', '') }}</textarea>
    ...
    <script>
        ...
        if (creationForm) {
            ...
            creationForm.addEventListener('submit', (e) => {
                ...
                errors += validateNumber(costInput, costInput.nextElementSibling, 0.05)
                errors += validateNumber(quantityInput, quantityInput.nextElementSibling, 1)
                errors += validateNumber(priceInput, priceInput.nextElementSibling, 0.05)
                if (!errors) {
                    creationForm.submit()
                }
            })
