        ...
        <div class="sale-wrapper">
            ...
            <div class="sale-cart " id="sale-cart">
                <div class="cart-holder">
                    <form action="{{ route('seller.sales.update', $sale->id) }}" id="cart-form" method="post">
                        @csrf
                        @method('PATCH')
                        ...
                        <input type="hidden" name="cart" id="cartInput" value="{{ old('cart', $stringCart) }}">
                        ...
                        <div class="buttons d-flex j-end gap-1 wrap mt-1 d-none" id="btns-holder">
                            ...
                            <button type="submit" id="submitBtn" class="submitBtn">Update Sale</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        function updateCart() {
            ...
            cart.forEach((product) => {
                ...
                tr.setAttribute('data-productid', parseFloat(product.product_id))
                ...
                productNameLink.href = `${baseUrl}seller/products/details/${product.product_id}`;
