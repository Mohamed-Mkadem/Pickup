    ...
    <section class="content" id="content">
        ...
        @if ($seller->verification == 'Unverified')
            <div class="alert alert-info">
                <h3>Info</h3>
                <p>
                    Only Verified Sellers Are Able To Create Stores, <a
                        href="{{ route('seller.verification-requests.create') }}">Create A Verification Request</a>
                </p>
            </div>
        @elseif ($seller->hasStore())
            <div class="alert alert-info">
                <h3>Info</h3>
                <p>
                    You Cannot Create Another Store because You Are Already Created One!
                </p>
            </div>
        @else
            <form action="{{ route('seller.stores.store') }}" id="store-form" method="post" enctype="multipart/form-data">
                @csrf
                <div class="main-holder">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="username" value="{{ old('username', '') }}" id="username-input"
                    ...
                    <div class="form-row">
                                ...
                                <select name="sector_id" id="sector-select" class="form-element">
                                    @foreach ($sectors as $sector)
                                        <option value="{{ $sector->id }}"
                                            {{ old('sector_id') ?? $sector->id ? 'selected' : '' }}>{{ $sector->name }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="phone" value="{{ old('phone', '') }}" class="form-element"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="address" value="{{ old('address', '') }}" class="form-element"
                    ...
                    <div class="form-row">
                        <div class="editor-holder pop-up-editor">
                            ...
                            <textarea name="bio" class="form-element" id="bio-input" cols="30" rows="10">{{ old('bio', '') }}</textarea>
                ...
                <div class="main-holder">
                                ...
                                <div class="day">
                                    ...
                                    <div class="hours-holder">
                                        <div class="hour">
                                            ...
                                            <input type="time" class="form-element" value="08:00"
                                        ...
                                        <div class="hour">
                                            ...
                                            <input type="time" class="form-element" value="21:00"
                    ...
                    <div class="buttons d-flex j-end gap-1 wrap mt-1">
                        ...
                        <button type="submit" id="submitBtn" class="submitBtn">Create Store</button>
    ...
    <script>
        ...
        if (storeForm) {
            ...
            storeForm.addEventListener('submit', (e) => {
                ...
                errors += validateField(userNameInput, userNameInput.nextElementSibling)
