        ...
        <div class="show-header clients d-flex j-start  a-center  col main-holder">
            ...
            <div class="info-holder">
                <div class="top-header d-flex col j-center a-center">
                    <h2>{{ $request->seller->user->first_name . ' ' . $request->seller->user->last_name }}
                        ({{ $request->seller->user->status }}) </h2>
                ...
                <div class="details">
                    <p class="mb-1">
                        {{ $request->seller->user->city->state->name . ' - ' . $request->seller->user->city->name }}</p>
