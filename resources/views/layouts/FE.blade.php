...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('dist/CSS/fe.css') }}">
    ...
    @stack('styles')
    <link href="https://cdn.jsdelivr.net/gh/duyplus/fontawesome-pro/css/all.min.css" rel="stylesheet"
        type="text/css" />
</head>
...
<body>
    ...
    <header>
        <div class="top-menu">
            <div class="container">
                <div class="wrapper">
                    <a class="start-selling-btn" href="{{ route('startSellingPage') }}"><i class="fa-solid fa-sack-dollar"></i> Start
                        Selling</a>
                    <div class="seller-links">
                        <p role="button" aria-pressed="false" id="seller-dialogue-toggle" class="dropdown-toggle">Seller
                            <span> : </span> <i class="fa-solid fa-caret-down"></i>
                        </p>
                        <ul class="links dropdown-menu" id="sellerDropdown">
                            <li><a href="{{ route('seller/login') }}" class="s-login"><i class="fa-light fa-user"></i> Login</a> </li>
                            <li class="span-holder"> <span> / </span> </li>
                            <li><a href="{{ route('sellerRegister') }}" class="s-register"><i class="fa-light fa-user-plus"></i>
                                    Register</a> </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="main-menu">
                <div class="col logo-col">
                    ...
                    <a href="{{ route('homePage') }}" class="logo"><i class="fa-light fa-bag-shopping"></i> <span>Pickup</span> </a>
                </div>
                <nav id="main-nav">
                    <button id="close-main-nav" aria-controls="#main-nav"><i
                            class="fa-light fa-square-xmark"></i></button>
                    <ul>
                        <li><a href="{{ route('homePage') }}" class="  {{ request()->is('/') ? 'active' : '' }}"><i class="fa-thin fa-house"></i> <span> Home </span></a>
                        </li>
                        <li><a href="{{ route('aboutPage') }}" class=" {{ request()->is('about') ? 'active' : '' }}"><i class="fa-thin fa-circle-info"></i> <span> About </span></a></li>
                        <li><a href="{{ route('contactPage') }}" class=" {{ request()->is('contact') ? 'active' : '' }}"><i class="fa-thin fa-user-headset"></i> <span> Contact </span></a>
                        </li>
                        <li><a href="{{ route('trackOrderPage') }}" class=" {{ request()->is('track-order*') ? 'active' : '' }}"><i class="fa-thin fa-cart-plus"></i> <span> Track Order
                                </span></a></li>
                ...
                <div class="col drops-col">
                    <div class="client-links">
                        ...
                        <ul class="links dropdown-menu" id="client-dropdown">
                            <li><a href="{{ route('login') }}" class="c-login"><i class="fa-light fa-user"></i> Login</a> </li>
                            <li><a href="{{ route('register') }}" class="c-register"><i class="fa-light fa-user-plus"></i> Register</a> </li>
                        </ul> 
                        @endguest
                        @auth                            
                        <button class="icon-btn dropdown-toggle auth" id="auth-dropdown-toggle" aria-pressed="false"
                            aria-controls="#auth-dropdown"><i class="fa-light fa-circle-user"></i> Mohamed <i
                                class="fa-solid fa-caret-down"></i></button>
                        <ul class="links dropdown-menu auth" id="auth-dropdown">
                            <li><a href="" class="c-login"><i class="fa-light fa-house"></i> Dashboard</a> </li>
                            <li>
